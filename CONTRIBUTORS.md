...
| --- | --- | --- | --- | --- |
| Root repository router | Current `VeryMath/AI4Math-Evolving` repository | [Conan Xu](https://github.com/ConanXu-math) | Root README, bilingual repository map, package routing layer, and public repository structure. | Preserved through repository commit history. |
| `skills/openevolve-experiment-workflow` | Current `VeryMath/AI4Math-Evolving` repository | [Conan Xu](https://github.com/ConanXu-math) | OpenEvolve experiment workflow, dry-run gates, scripts, references, and package normalization. | Preserved through repository commit history. |
