...
concrete Skill file. For local discovery, link or copy only the concrete Skill
folder into the Codex Skill path used by your installation, then restart or
reload Codex if required.
